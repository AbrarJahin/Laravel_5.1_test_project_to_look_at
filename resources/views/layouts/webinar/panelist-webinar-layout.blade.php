                            ...
                            <ul class="sub-container">
                                ...
                                <li class="sub-info">
                                    <ul>
                                        ...
                                        @if($is_panelist)
                                        <li><label>Welcome Panelist</label></li>
                                        @endif
                                        <li>Shared Url:</li>
                                ...
                                <li class="sub-info">
                                    <ul class="device">
                                        ...
                                        <section class="module">
                                            ...
                                            <input class="btn btn-info" type="submit" name="submit" value="Private">
                                            <input class="btn btn-info" type="submit" name="submit" value="Public">
                                        </section>
                                ...
                                <li class="sub-info">
                                    <ul class="device">
                                        ...
                                        <section class="module2">
                                            ...
                                            <input class="quest-control" type="text" class="faq" name="questions" placeholder="Ask your Questions here ???"><input class="send-btn" type="submit" name="submit" value="send">
                                        </section>
